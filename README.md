# [github p5moExamples](https://github.com/molab-itp/p5moExamples.git) ?v=72
...
## [github.io versions of examples](https://molab-itp.github.io/p5moExamples?v=72)

- [examples/dice99](examples/dice99?v=72)

- [examples/vote](examples/vote?v=72)
- [examples/vote_DOMjs](examples/vote_DOMjs?v=72)
- [examples/words](examples/words?v=72)
- [examples/videoKit](examples/videoKit?v=72)
- [examples/photo-booth](examples/photo-booth?v=72)
- [examples/iframe_player](examples/iframe_player?v=72)

- [examples/lobby room0](examples/lobby?v=72&room=room0)
- [examples/lobby room1](examples/lobby?v=72&room=room1)
- [examples/paint](examples/paint?v=72)
- [examples/paint remote=0](examples/paint?v=72&remote=0)
- [examples/pixel-grid](examples/pixel-grid?v=72)
- [examples/pixel-grid remote=0](examples/pixel-grid?v=72&remote=0)
