# [github p5moExamples](https://github.com/molab-itp/p5moExamples.git) ?v=86
...
## [github.io versions of examples](https://molab-itp.github.io/p5moExamples?v=86)

- [examples/shout](examples/shout?v=86)
- [examples/video-radial-scan](examples/video-radial-scan?v=86)
- [examples/dice99](examples/dice99?v=86)
- [examples/faceMesh](examples/faceMesh?v=86)

- [examples/vote](examples/vote?v=86)
- [examples/vote_DOMjs](examples/vote_DOMjs?v=86)
- [examples/words](examples/words?v=86)
- [examples/videoKit](examples/videoKit?v=86)
- [examples/photo-booth](examples/photo-booth?v=86)
- [examples/iframe_player](examples/iframe_player?v=86)

- [examples/lobby room0](examples/lobby?v=86&room=room0)
- [examples/lobby room0 mo-videoplayer](examples/lobby?v=86&room=room0&app=mo-videoplayer)
- [examples/lobby room1](examples/lobby?v=86&room=room1)

- [examples/paint](examples/paint?v=86)
- [examples/paint remote=0](examples/paint?v=86&remote=0)
- [examples/pixel-grid](examples/pixel-grid?v=86)
- [examples/pixel-grid remote=0](examples/pixel-grid?v=86&remote=0)
