# [p5moExamples](https://github.com/molab-itp/p5moExamples.git) ?v=60
...
## [github.io versions of examples](https://molab-itp.github.io/p5moExamples?v=60)

- [examples/vote](examples/vote?v=60)
- [examples/vote_DOMjs](examples/vote_DOMjs?v=60)
- [examples/words](examples/words?v=60)
- [examples/video](examples/video?v=60)
- [examples/photo-booth](examples/photo-booth?v=60)
- [examples/iframe_player](examples/iframe_player?v=60)

- [examples/lobby room0](examples/lobby?v=60&room=room0)
- [examples/lobby room1](examples/lobby?v=60&room=room1)
- [examples/paint](examples/paint?v=60)
- [examples/paint remote=0](examples/paint?v=60&remote=0)
- [examples/pixel-grid](examples/pixel-grid?v=60)
- [examples/pixel-grid remote=0](examples/pixel-grid?v=60&remote=0)
