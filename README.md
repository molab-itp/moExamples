# [github p5moExamples](https://github.com/molab-itp/p5moExamples.git) ?v=104
...
## [github.io versions of examples](https://molab-itp.github.io/p5moExamples?v=104)

- [examples/let-america-rewind](examples/let-america-rewind?v=104)
- [examples/faceMesh](examples/faceMesh?v=104)

- [examples/shout](examples/shout?v=104)
- [examples/video-radial-scan](examples/video-radial-scan?v=104)
- [examples/dice99](examples/dice99?v=104)

- [examples/vote](examples/vote?v=104)
- [examples/vote_DOMjs](examples/vote_DOMjs?v=104)
- [examples/words](examples/words?v=104)
- [examples/videoKit](examples/videoKit?v=104)
- [examples/photo-booth](examples/photo-booth?v=104)
- [examples/iframe_player](examples/iframe_player?v=104)

- [examples/lobby room0](examples/lobby?v=104&room=room0)
- [examples/lobby room0 mo-videoplayer](examples/lobby?v=104&room=room0&app=mo-videoplayer)
- [examples/lobby room1](examples/lobby?v=104&room=room1)

- [examples/paint](examples/paint?v=104)
- [examples/paint remote=0](examples/paint?v=104&remote=0)
- [examples/pixel-grid](examples/pixel-grid?v=104)
- [examples/pixel-grid remote=0](examples/pixel-grid?v=104&remote=0)
