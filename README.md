# [github p5moExamples](https://github.com/molab-itp/p5moExamples.git) ?v=95
...
## [github.io versions of examples](https://molab-itp.github.io/p5moExamples?v=95)

- [examples/shout](examples/shout?v=95)
- [examples/video-radial-scan](examples/video-radial-scan?v=95)
- [examples/dice99](examples/dice99?v=95)
- [examples/faceMesh](examples/faceMesh?v=95)

- [examples/vote](examples/vote?v=95)
- [examples/vote_DOMjs](examples/vote_DOMjs?v=95)
- [examples/words](examples/words?v=95)
- [examples/videoKit](examples/videoKit?v=95)
- [examples/photo-booth](examples/photo-booth?v=95)
- [examples/iframe_player](examples/iframe_player?v=95)

- [examples/lobby room0](examples/lobby?v=95&room=room0)
- [examples/lobby room0 mo-videoplayer](examples/lobby?v=95&room=room0&app=mo-videoplayer)
- [examples/lobby room1](examples/lobby?v=95&room=room1)

- [examples/paint](examples/paint?v=95)
- [examples/paint remote=0](examples/paint?v=95&remote=0)
- [examples/pixel-grid](examples/pixel-grid?v=95)
- [examples/pixel-grid remote=0](examples/pixel-grid?v=95&remote=0)
