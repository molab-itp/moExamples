# [github p5moExamples](https://github.com/molab-itp/p5moExamples.git) ?v=106
...
## [github.io versions of examples](https://molab-itp.github.io/p5moExamples?v=106)

- [examples/let-america-rewind](examples/let-america-rewind?v=106)
- [examples/faceMesh](examples/faceMesh?v=106)

- [examples/shout](examples/shout?v=106)
- [examples/video-radial-scan](examples/video-radial-scan?v=106)
- [examples/dice99](examples/dice99?v=106)

- [examples/vote](examples/vote?v=106)
- [examples/vote_DOMjs](examples/vote_DOMjs?v=106)
- [examples/words](examples/words?v=106)
- [examples/videoKit](examples/videoKit?v=106)
- [examples/photo-booth](examples/photo-booth?v=106)
- [examples/iframe_player](examples/iframe_player?v=106)

- [examples/lobby room0](examples/lobby?v=106&room=room0)
- [examples/lobby room0 mo-videoplayer](examples/lobby?v=106&room=room0&app=mo-videoplayer)
- [examples/lobby room1](examples/lobby?v=106&room=room1)

- [examples/paint](examples/paint?v=106)
- [examples/paint remote=0](examples/paint?v=106&remote=0)
- [examples/pixel-grid](examples/pixel-grid?v=106)
- [examples/pixel-grid remote=0](examples/pixel-grid?v=106&remote=0)
