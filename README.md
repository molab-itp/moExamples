# [github p5moExamples](https://github.com/molab-itp/p5moExamples.git) ?v=89
...
## [github.io versions of examples](https://molab-itp.github.io/p5moExamples?v=89)

- [examples/shout](examples/shout?v=89)
- [examples/video-radial-scan](examples/video-radial-scan?v=89)
- [examples/dice99](examples/dice99?v=89)
- [examples/faceMesh](examples/faceMesh?v=89)

- [examples/vote](examples/vote?v=89)
- [examples/vote_DOMjs](examples/vote_DOMjs?v=89)
- [examples/words](examples/words?v=89)
- [examples/videoKit](examples/videoKit?v=89)
- [examples/photo-booth](examples/photo-booth?v=89)
- [examples/iframe_player](examples/iframe_player?v=89)

- [examples/lobby room0](examples/lobby?v=89&room=room0)
- [examples/lobby room0 mo-videoplayer](examples/lobby?v=89&room=room0&app=mo-videoplayer)
- [examples/lobby room1](examples/lobby?v=89&room=room1)

- [examples/paint](examples/paint?v=89)
- [examples/paint remote=0](examples/paint?v=89&remote=0)
- [examples/pixel-grid](examples/pixel-grid?v=89)
- [examples/pixel-grid remote=0](examples/pixel-grid?v=89&remote=0)
