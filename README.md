# [github p5moExamples](https://github.com/molab-itp/p5moExamples.git) ?v=83
...
## [github.io versions of examples](https://molab-itp.github.io/p5moExamples?v=83)

- [examples/shout](examples/shout?v=83)
- [examples/video-radial-scan](examples/video-radial-scan?v=83)
- [examples/dice99](examples/dice99?v=83)

- [examples/vote](examples/vote?v=83)
- [examples/vote_DOMjs](examples/vote_DOMjs?v=83)
- [examples/words](examples/words?v=83)
- [examples/videoKit](examples/videoKit?v=83)
- [examples/photo-booth](examples/photo-booth?v=83)
- [examples/iframe_player](examples/iframe_player?v=83)

- [examples/lobby room0](examples/lobby?v=83&room=room0)
- [examples/lobby room1](examples/lobby?v=83&room=room1)
- [examples/paint](examples/paint?v=83)
- [examples/paint remote=0](examples/paint?v=83&remote=0)
- [examples/pixel-grid](examples/pixel-grid?v=83)
- [examples/pixel-grid remote=0](examples/pixel-grid?v=83&remote=0)
